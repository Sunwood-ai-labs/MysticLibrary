---
title: Graphic Recording Slide v4 Ryoka × Yoryo
description: Generate graphic recording-style presentation with horizontal scroll functionality
category: docs
...
canonical_id: "docs/graphic-recording/graphic-recording-slide-v4"
prompt_source: "prompts/docs-first/docs/graphic-recording/graphic-recording-slide-v4_EN.md"
---
...
```
Create [Input Document/Content] as horizontal scroll-enabled presentation slides in HTML/CSS/JavaScript
...
Actively use Font Awesome icons to visually organize information in friendly, easy-to-understand design
Also use the Ryoka color map and fonts specified below
Express handwritten feel and warmth of graphic recording
```
