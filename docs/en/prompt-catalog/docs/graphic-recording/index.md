...
description: Real-time visual summaries of discussions using diagrams, illustrations, and text
category: docs
...
Graphic Recording is a technique for summarizing meeting and presentation content in real-time using diagrams, illustrations, and text. It makes it easier to grasp the overall picture of discussions and encourages idea generation.
...
- [Consulting-Style Infographic V1](./consulting-infographic-v1.md) - Fashion color palette consulting-style infographic (2-column)
- [Graphic Recording Style Infographic V2](./consulting-infographic-v2.md) - Fashion color palette graphic recording style infographic (3-column)
...
- [Graphic Recording HTML v2 MysticLibrary](./graphic-recording-html-mysticlibrary.md) - MysticLibrary color palette professional version (3-column)
- [Graphic Recording HTML v3 UI/UX](./graphic-recording-html-uiux.md) - UI/UX color palette icon-focused version (4-column)
- [Graphic Recording HTML v5 UI/UX Theme](./graphic-recording-html-v5.md) - UI/UX color palette with large icons
- [Graphic Recording Timeline v1](./graphic-recording-timeline-v1.md) - Dark illustration colors (green/yellow) timeline
...
2. Input the text content you want to transform
3. Display and save the generated HTML in a browser
4. Adjust using edit mode if necessary

## Features

- Visual expression using Font Awesome icons
- Warm design with handwritten-style fonts
- Responsive design
