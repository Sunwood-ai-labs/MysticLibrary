---
title: Graphic Recording HTML Creation V2 Full Moon Dark Theme
description: Prompt for generating dark theme graphic recording HTML with Full Moon color palette
category: docs
...
canonical_id: "docs/graphic-recording/graphic-recording-html-v2-dark"
prompt_source: "prompts/docs-first/docs/graphic-recording/graphic-recording-html-v2-dark_EN.md"
---

# Graphic Recording HTML Creation V2 Full Moon Dark Theme

## Intended Use

- Create graphic recording with dark theme
- Utilize mystical atmosphere of Full Moon color palette
- Express stars shining in the darkness of night

## Prompt

```text
# Graphic Recording (Graleco) HTML Creation Prompt V2 (Full Moon Dark Theme)
...
## Color Palette (Full Moon Dark Theme)
```
<palette>
...
- Future schedule decision
- Assignment of responsible persons
```

## Output Example

Dark theme 5-column graphic recording HTML with Full Moon color palette (dark green #010D00, beige #D9CAB0, brown #A69177) will be generated.

## Notes

- Dark theme requires attention to visibility
