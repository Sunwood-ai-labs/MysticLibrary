---
title: Windsurf System Prompt V1
description: Japanese language system prompt for Windsurf (based on DRY, KISS, YAGNI principles)
category: dev
...
# Windsurf System Prompt V1

## Intended Use

- Development work in Windsurf editor
- Code creation in Japanese language environment
...
3. Get Japanese responses with code/documentation following the principles
...
- Language policy: Code elements in English, documentation in Japanese
- README.md creation and update is mandatory
- Follow 10 development principles
- Commit messages use emoji + convention format
