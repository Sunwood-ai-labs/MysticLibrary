...
Development and operations prompts have been reorganized into task-based subcategories.

## Categories

- [Triage](./triage/index.md)
- [Review / Quality](./review/index.md)
- [Checklists](./checklists/index.md)
- [Templates (logs / handoff formats)](./templates/index.md)
...
- Start with the task goal (triage / review / drafting / operational rules)
- Check `intent` and `input_requirements` first and fill missing inputs before running
- Final prioritization and approvals should be made by humans
