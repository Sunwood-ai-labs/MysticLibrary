...
prompt_source: "prompts/docs-first/agent/phidata/phidata-multi-agent-template_EN.md"
---
...
- This page is the **source-of-truth** entry in `agent` catalog.
- It is sourced from `prompts/Company-as-a-Code/Phidata-Prompt-Template_EN.md`.
- The implementation-oriented variant is [Phidata Multi-Agent Template (dev guide)](../../dev/agent-prompts/phidata-multi-agent-template.md).

## Intended Use

- Designing multi-agent AI systems using Phidata framework
- Automatic generation of organizational structure and AI agent mapping
- Implementation code generation for team-based AI systems
...
1. Describe the project purpose specifically
2. Input the prompt to AI
3. Generate organizational structure and agent design
4. Review and customize implementation code
...
- Complete list of required AI agents
- Data flow diagram
- Implementation code using Phidata

## Notes

- The more specific the project purpose description, the higher quality design you'll get
- Generated code needs adjustment for actual environment
- Agent collaboration methods should be optimized according to project scale
