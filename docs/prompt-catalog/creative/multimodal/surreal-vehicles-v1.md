...
prompt_source: "prompts/docs-first/creative/multimodal/surreal-vehicles-v1_JP.md"
---
...
1. **IMAGE PROMPT (for Midjourney / SDXL etc.)** - 英語プロンプト
2. **VIDEO PROMPT (for Runway Gen-3, Pika, Stable Video Diffusion etc.)** - 英語プロンプト + 技術オプション
