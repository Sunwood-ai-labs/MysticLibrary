...
legacy_source: "prompts/diagram/aws_drawio_architecture_diagram_generator_v4_JP.md"
prompt_source: "prompts/docs-first/docs/diagram/aws-drawio-architecture-v4_JP.md"
---
