...
description: "Imported X marker post (2025-12-07 19:39:09 JST)"
category: archive
...
canonical_id: "archive/x/2025/12/1997616865347252552"
prompt_source: "prompts/docs-first/archive/x/2025/12/1997616865347252552_JP.md"
---

# 🍌 nano banana pro エージェントV1.2を使って「世界遺産の巨大ジオラマを作成するプロンプト」爆誕

## 抽出サマリー
- 投稿日時: 2025-12-07 19:39:09 JST
- レコード種別: tweet + note
- canonical body: note
- summary: あなたは国立博物館の展示を手掛ける**「マスター・ジオラマ・アーキテクト(建築模型士)」**です。

## Categorized Entry
- canonical doc: [creative/visual/character-styles](../../../../creative/visual/character-styles/nano-banana-pro-diorama-crowd.md)
...
## 抽出ノート
- tweet ids: 1997616865347252552
- note ids: 1997616865175318528
- cluster items: tweet:1997616865347252552, note:1997616865175318528
