...
prompt_source: "prompts/docs-first/archive/x/2025/10/1978371834828722239_JP.md"
---

# 「Google Fonts Icons」をChatGPTのCanvasで手軽に試せるプロンプト作りました!!!

## 抽出サマリー
- 投稿日時: 2025-10-15 17:06:16 JST
- レコード種別: tweet + note
- canonical body: note
- summary: ⚙️ System Prompt — 「Google Fonts Icons を多用したHTMLを**生成**するアシスタント」

## Categorized Entry
- canonical doc: [dev/system-prompts](../../../../dev/system-prompts/role-system-google-fonts.md)
...
## 抽出ノート
- tweet ids: 1978371834828722239
- note ids: 1978371834442850304
- cluster items: tweet:1978371834828722239, note:1978371834442850304
