...
prompt_source: "prompts/docs-first/archive/x/2025/06/1938587898728865792_JP.md"
---

# 「カラーマップ生成プロンプト v2.0」✖ 「Instagram用画像スライドインフォグラフィック作成プロンプト V2.0」やってみた!!!

## 抽出サマリー
- 投稿日時: 2025-06-27 22:19:06 JST
- レコード種別: note only
- canonical body: note
- summary: Instagram用画像スライドインフォグラフィック作成プロンプト V2.0

## Categorized Entry
- canonical doc: [docs/graphic-recording/slide-infographics](../../../../docs/graphic-recording/slide-infographics/colormap-slides-spec-instagram.md)
...
<head>
 ...
 <!-- フォント・アイコン読み込み -->
 <link href="https://t.co/qByaAmhr7E" rel="stylesheet">
...
<body>
 ...
 a.href = url;
 https://t.co/X8gORggwqu = `instagram-slide-${slideNumber}.png`;
 https://t.co/vmouOeYTw7();
...
### タイトルスライド
```svg
<svg width="600" height="600" viewBox="0 0 600 600" xmlns="https://t.co/2HAghLaxya" id="slide1-svg">
 <defs>
...
### データスライド
```svg
<svg width="600" height="600" viewBox="0 0 600 600" xmlns="https://t.co/2HAghLaxya" id="slide2-svg">
...
## 抽出ノート
- tweet ids: none
- note ids: 1938587898728865792
- cluster items: note:1938587898728865792
