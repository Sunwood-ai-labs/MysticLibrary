...
description: "Imported X marker post (2025-06-28 11:10:52 JST)"
category: archive
...
canonical_id: "archive/x/2025/06/1938782120169873880"
prompt_source: "prompts/docs-first/archive/x/2025/06/1938782120169873880_JP.md"
---

# 入力画像も描画する「カラーマップ生成プロンプト v3.0」リリース!!!

## 抽出サマリー
- 投稿日時: 2025-06-28 11:10:52 JST
- レコード種別: tweet + note
- canonical body: note
- summary: 🎨 カラーマップ生成プロンプト v3.0 - 画像URL対応・LP風・FontAwesome強化版

## Categorized Entry
- canonical doc: [creative/visual/image-edits](../../../../creative/visual/image-edits/colormap-url-fontawesome-v3-0.md)
...
### 📥 入力パターン対応
1. **直接URL**: `https://t.co/j5Ct7QZMhO`
2. **GitHub Assets**: `https://t.co/xJRrAT5HT8...`
...
## 抽出ノート
- tweet ids: 1938782120169873880
- note ids: 1938782118949376000
- cluster items: tweet:1938782120169873880, note:1938782118949376000
