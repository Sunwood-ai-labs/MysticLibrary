...
description: "Imported X marker post (2025-06-27 21:31:44 JST)"
category: archive
...
canonical_id: "archive/x/2025/06/1938575975706701861"
prompt_source: "prompts/docs-first/archive/x/2025/06/1938575975706701861_JP.md"
---

# 画像からライトテーマとダークテーマのカラーマップのLPを作成するプロンプト「カラーマップ生成プロンプト v2.0」できた!!

## 抽出サマリー
- 投稿日時: 2025-06-27 21:31:44 JST
- レコード種別: tweet + note
- canonical body: note
- summary: 🎨 カラーマップ生成プロンプト v2.0 - LP風・FontAwesome強化版

## Categorized Entry
- canonical doc: [creative/visual](../../../../creative/visual/colormap-fontawesome-v2-0.md)
...
## 抽出ノート
- tweet ids: 1938575975706701861
- note ids: 1938575974905577472
- cluster items: tweet:1938575975706701861, note:1938575974905577472
