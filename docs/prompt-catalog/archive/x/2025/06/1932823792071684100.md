...
description: "Imported X marker post (2025-06-12 00:34:36 JST)"
category: archive
...
marker: true
canonical_id: "archive/x/2025/06/1932823792071684100"
prompt_source: "prompts/docs-first/archive/x/2025/06/1932823792071684100_JP.md"
---

# コミック調HTMLジェネレーター プロンプト V1.0 爆誕

## 抽出サマリー
- 投稿日時: 2025-06-12 00:34:36 JST
- レコード種別: note only
- canonical body: note
- summary: コミック調HTMLジェネレーター プロンプト V1.0

## Categorized Entry
- canonical doc: [docs/graphic-recording](../../../../docs/graphic-recording/comic-v1-0.md)
...
<head>
 ...
 <title>[タイトル]</title>
 <style>
 @import url('https://t.co/92Yg8kCkxU');
...
## 抽出ノート
- tweet ids: none
- note ids: 1932823792071684100
- cluster items: note:1932823792071684100
