...
description: "Imported X marker post (2025-06-21 23:08:53 JST)"
category: archive
...
canonical_id: "archive/x/2025/06/1936426098948215212"
prompt_source: "prompts/docs-first/archive/x/2025/06/1936426098948215212_JP.md"
---

# 「編集可能グラレコサムネプロンプト✖ 涼雅 V4」リリース!!!

## 抽出サマリー
- 投稿日時: 2025-06-21 23:08:53 JST
- レコード種別: tweet + note
- canonical body: note
- summary: 編集可能 グラレコサムネイルプロンプト v4 ~涼雅(りょうが)~

## Categorized Entry
- canonical doc: [docs/graphic-recording](../../../../docs/graphic-recording/graphic-recording-thumbnail-v4.md)
...
<link href="https://t.co/iieQMV3fjG" rel="stylesheet">
```
...
editBtn.onclick = () => {
 ...
 https://t.co/tGLon2wPTI.background = 'var(--current-neon)';
 https://t.co/tGLon2wPTI.color = 'var(--current-primary)';
 } else {
 editIcon.className = 'fas fa-edit';
 editText.textContent = '編集モード';
 https://t.co/tGLon2wPTI.background = 'var(--current-primary)';
 https://t.co/tGLon2wPTI.color = 'white';
 }
};
...
themeBtn.onclick = () => {
 ...
 setTimeout(() => {
 https://t.co/9y1Y4Qsxue.background = 'var(--current-accent)';
 if (!editing) {
 https://t.co/tGLon2wPTI.background = 'var(--current-primary)';
 }
 }, 50);
...
/* 青海波パターン */
.seigaiha-pattern {
 background-image: url("data:image/svg+xml,%3Csvg xmlns='https://t.co/2HAghLaxya' viewBox='0 0 100 100'%3E%3Cpath d='M0,50 Q25,25 50,50 T100,50' stroke='%23038C8C' fill='none' opacity='0.1'/%3E%3C/svg%3E");
}
```
...
.constellation-pattern {
 background-image: url("data:image/svg+xml,%3Csvg xmlns='https://t.co/2HAghLaxya' viewBox='0 0 100 100'%3E%3Ccircle cx='20' cy='20' r='1' fill='%23F2C166' opacity='0.6'/%3E%3Ccircle cx='80' cy='30' r='0.5' fill='%2366D9EF' opacity='0.8'/%3E%3Ccircle cx='60' cy='70' r='0.8' fill='%2304BFAD' opacity='0.7'/%3E%3C/svg%3E");
}
```
...
<head>
 ...
 <!-- Font Awesome CDN -->
 <link rel="stylesheet" href="https://t.co/BjYYKjdDl8">
...
## 抽出ノート
- tweet ids: 1936426098948215212
- note ids: 1936426097224425472
- cluster items: tweet:1936426098948215212, note:1936426097224425472
