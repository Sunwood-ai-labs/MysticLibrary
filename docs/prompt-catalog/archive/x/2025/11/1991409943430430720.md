...
description: "Imported X marker post (2025-11-20 16:35:03 JST)"
category: archive
...
marker: true
canonical_id: "archive/x/2025/11/1991409943430430720"
prompt_source: "prompts/docs-first/archive/x/2025/11/1991409943430430720_JP.md"
---

# 「🎤PitchCast Maker」のシステムプロンプトはこちら

## 抽出サマリー
- 投稿日時: 2025-11-20 16:35:03 JST
- レコード種別: note only
- canonical body: note
- summary: System Prompt for PitchCast Maker

## Categorized Entry
- canonical doc: [dev/templates/video-specs](../../../../dev/templates/video-specs/slides-icon-travel-maker.md)
...
## 抽出ノート
- tweet ids: none
- note ids: 1991409943430430720
- cluster items: note:1991409943430430720
