...
prompt_source: "prompts/docs-first/archive/x/2026/03/2030264603125682331_JP.md"
---

# playwright-interactive を使って、ゼロからブラウザで動く three.js のボクセルゲームアプリを作ってください。

## 抽出サマリー
- 投稿日時: 2026-03-07 21:49:36 JST
- レコード種別: tweet + note
- canonical body: note
- summary: playwright-interactive を使って、ゼロからブラウザで動く three.js のボクセルゲームアプリを作ってください。

## Categorized Entry
- canonical doc: [creative/game](../../../../creative/game/game-voxel-browser-github.md)
...
## 抽出ノート
- tweet ids: 2030264603125682331
- note ids: 2030264602727194624
- cluster items: tweet:2030264603125682331, note:2030264602727194624
