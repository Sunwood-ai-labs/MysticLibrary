...
prompt_source: "prompts/docs-first/archive/x/2026/02/2018343568428183886_JP.md"
---
...
## Categorized Entry
- canonical doc: [dev/agent-prompts](../../../../dev/agent-prompts/openclaw-ssh-maki-jetson-openclaw-docker.md)
