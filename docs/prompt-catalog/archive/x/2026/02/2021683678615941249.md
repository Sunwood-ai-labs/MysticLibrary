---
title: "This file provides guidance to Claude Code ( when working with code in this repository."
...
- レコード種別: tweet + note
- canonical body: note
- summary: This file provides guidance to Claude Code ( when working with code in this rep…
...
> [!IMPORTANT]
> 新しいリポジトリを作成する場合は、必ず **[Sunwood-AI-OSS-Hub]( 組織内に作成してください。
