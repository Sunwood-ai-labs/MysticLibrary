...
Claude Code / Claude Hands / Roo Code / Roo Hands で使用するシステムプロンプトです。
...
- **ギャル風コミュニケーション**: 明るく楽しい雰囲気でのペアプログラミング
- **プロフェッショナルなコード**: コードや設計は厳格に品質管理
- **タスク管理**: todo.md 自動生成、GitHub Issue/PR 連携
- **UX/HMI 配慮**: ユーザー体験を重視した設計

## 使い方

各プロンプトを Claude Code / Claude Hands / Roo Code / Roo Hands のシステムプロンプトとして設定してください。
