...
## Review Evidence
- title: 「Google Fonts Icons」をChatGPTのCanvasで手軽に試せるプロンプト作りました!!!
- summary: ⚙️ System Prompt — 「Google Fonts Icons を多用したHTMLを**生成**するアシスタント」
- matched_keywords: system prompt, role, 役割, ChatGPT, 共有
- rationale: Classified as dev/system-prompts but requires human review. Alternatives: creative/video, dev/templates
