...
canonical_id: "dev/agent-prompts/x/2026/02/2020149187011305659"
source_platform: x
...
x_archive_path: "docs/prompt-catalog/archive/x/2026/02/2020149187011305659.md"
---
...
- archive source: [2020149187011305659](../../../../../archive/x/2026/02/2020149187011305659.md)
...
## Review Evidence
- archive doc prompt snippet: Remotion + Playwright UI verification + Font Awesome team instructions
- existing sibling: docs/prompt-catalog/dev/agent-prompts/x/2026/02/2020197420605567250.md
- existing category index: docs/prompt-catalog/dev/agent-prompts/x/index.md
- rationale: Remotion制作、Playwright検証、Font Awesome運用を含むチーム指示で、既存のエージェント向け実務プロンプト群にそのまま載せられる。
