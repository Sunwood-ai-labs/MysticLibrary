...
- 本ページは `agent` カタログ側の**正本**です。
- 元プロンプトは `prompts/Company-as-a-Code/Phidata-Prompt-Template_JP.md` を参照します。
- 開発運用向けの導入版は [phidata-multi-agent-template（開発向け）](../../dev/agent-prompts/phidata-multi-agent-template.md) です。
