...
canonical_doc: "docs/en/prompt-catalog/agent/minecraft/minecraft-mcp-builder-v1.0.md"
locale: EN
docs_first: true
last_synced: 2026-03-18
---

<!-- Generated from docs/en/prompt-catalog/agent/minecraft/minecraft-mcp-builder-v1.0.md. Edit docs/ instead. -->
