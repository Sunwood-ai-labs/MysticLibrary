...
description: "Minecraft MCPを使用して自律的に建築を行うBot用プロンプトの初期バージョン"
canonical_id: "agent/minecraft/minecraft-mcp-builder-v1.0"
canonical_doc: "docs/prompt-catalog/agent/minecraft/minecraft-mcp-builder-v1.0.md"
locale: JP
docs_first: true
last_synced: 2026-03-19
---

<!-- Generated from docs/prompt-catalog/agent/minecraft/minecraft-mcp-builder-v1.0.md. Edit docs/ instead. -->
...
- **v1.0**: 初期リリース。基本的な建築機能と干渉回避ロジック
- **v1.1**: コマンド優先戦略の強化、エラー対応の改善

## 関連プロンプト

- [Minecraft MCP 前提プロンプト v1.1](./minecraft-mcp-builder-v1.1.md) - 改良版の建築Botプロンプト
