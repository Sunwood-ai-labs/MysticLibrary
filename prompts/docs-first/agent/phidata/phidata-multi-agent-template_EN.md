---
title: "Phidata Multi-Agent Prompt Template"
description: "Template for automatically designing and implementing multi-agent AI systems using the Phidata framework"
canonical_id: "agent/phidata/phidata-multi-agent-template"
canonical_doc: "docs/en/prompt-catalog/agent/phidata/phidata-multi-agent-template.md"
locale: EN
docs_first: true
last_synced: 2026-03-19
---

<!-- Generated from docs/en/prompt-catalog/agent/phidata/phidata-multi-agent-template.md. Edit docs/ instead. -->
