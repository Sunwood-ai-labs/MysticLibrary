...
canonical_doc: "docs/en/prompt-catalog/dev/guidelines/codex-task-management-rules.md"
locale: EN
docs_first: true
last_synced: 2026-03-18
---

<!-- Generated from docs/en/prompt-catalog/dev/guidelines/codex-task-management-rules.md. Edit docs/ instead. -->
