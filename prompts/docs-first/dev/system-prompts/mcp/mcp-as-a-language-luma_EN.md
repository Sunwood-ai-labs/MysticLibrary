...
canonical_doc: "docs/en/prompt-catalog/dev/system-prompts/mcp/mcp-as-a-language-luma.md"
locale: EN
docs_first: true
last_synced: 2026-03-19
---

<!-- Generated from docs/en/prompt-catalog/dev/system-prompts/mcp/mcp-as-a-language-luma.md. Edit docs/ instead. -->
