---
title: "リポジトリ品質確認プロンプト V2"
description: "README品質、ドキュメント一貫性、環境設定、コード品質、プロジェクト構造をチェックするリポジトリ全体の品質確認プロンプト"
canonical_id: "dev/review/repo-review-prompt-v2"
canonical_doc: "docs/prompt-catalog/dev/review/repo-review-prompt-v2.md"
locale: JP
docs_first: true
last_synced: 2026-03-18
---

<!-- Generated from docs/prompt-catalog/dev/review/repo-review-prompt-v2.md. Edit docs/ instead. -->
