...
canonical_doc: "docs/prompt-catalog/dev/workflow/gh-issue-workflow-from-diff-v2.md"
locale: JP
docs_first: true
last_synced: 2026-03-18
---

<!-- Generated from docs/prompt-catalog/dev/workflow/gh-issue-workflow-from-diff-v2.md. Edit docs/ instead. -->
