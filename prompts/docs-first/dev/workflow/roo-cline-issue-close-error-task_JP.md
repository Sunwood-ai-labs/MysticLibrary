...
canonical_doc: "docs/prompt-catalog/dev/workflow/roo-cline-issue-close-error-task.md"
locale: JP
docs_first: true
last_synced: 2026-03-18
---

<!-- Generated from docs/prompt-catalog/dev/workflow/roo-cline-issue-close-error-task.md. Edit docs/ instead. -->
