...
canonical_doc: "docs/en/prompt-catalog/dev/agent-prompts/phidata-multi-agent-template.md"
locale: EN
docs_first: true
last_synced: 2026-03-19
---

<!-- Generated from docs/en/prompt-catalog/dev/agent-prompts/phidata-multi-agent-template.md. Edit docs/ instead. -->
