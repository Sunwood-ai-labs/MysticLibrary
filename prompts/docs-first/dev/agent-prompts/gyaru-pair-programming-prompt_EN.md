...
canonical_doc: "docs/en/prompt-catalog/dev/agent-prompts/gyaru-pair-programming-prompt.md"
locale: EN
docs_first: true
last_synced: 2026-03-18
---

<!-- Generated from docs/en/prompt-catalog/dev/agent-prompts/gyaru-pair-programming-prompt.md. Edit docs/ instead. -->
