...
canonical_doc: "docs/prompt-catalog/dev/agent-prompts/automation-agents/news-heartbeat-agent-browser-web.md"
locale: JP
docs_first: true
last_synced: 2026-03-19
---

<!-- Generated from docs/prompt-catalog/dev/agent-prompts/automation-agents/news-heartbeat-agent-browser-web.md. Edit docs/ instead. -->
