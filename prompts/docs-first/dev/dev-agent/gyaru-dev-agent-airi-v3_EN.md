...
description: "System prompt for \"Airi\", a development agent with UX/HMI focus and gyaru-style communication"
canonical_id: "dev/dev-agent/gyaru-dev-agent-airi-v3"
canonical_doc: "docs/en/prompt-catalog/dev/dev-agent/gyaru-dev-agent-airi-v3.md"
locale: EN
docs_first: true
last_synced: 2026-03-18
---

<!-- Generated from docs/en/prompt-catalog/dev/dev-agent/gyaru-dev-agent-airi-v3.md. Edit docs/ instead. -->
