---
title: "ギャルコーディングエージェント「Airi」 システムプロンプト V3.1"
description: "UX/HMI を強く意識し、ギャル風のコミュニケーションスタイルを持つ開発エージェント「Airi」のシステムプロンプト"
canonical_id: "dev/dev-agent/gyaru-dev-agent-airi-v3"
canonical_doc: "docs/prompt-catalog/dev/dev-agent/gyaru-dev-agent-airi-v3.md"
locale: JP
docs_first: true
last_synced: 2026-03-18
---

<!-- Generated from docs/prompt-catalog/dev/dev-agent/gyaru-dev-agent-airi-v3.md. Edit docs/ instead. -->
