...
canonical_doc: "docs/en/prompt-catalog/dev/templates/git-release-notes-generator-v1.md"
locale: EN
docs_first: true
last_synced: 2026-03-18
---

<!-- Generated from docs/en/prompt-catalog/dev/templates/git-release-notes-generator-v1.md. Edit docs/ instead. -->
