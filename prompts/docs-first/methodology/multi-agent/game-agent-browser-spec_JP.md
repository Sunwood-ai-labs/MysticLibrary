...
canonical_doc: "docs/prompt-catalog/methodology/multi-agent/game-agent-browser-spec.md"
locale: JP
docs_first: true
last_synced: 2026-03-19
---

<!-- Generated from docs/prompt-catalog/methodology/multi-agent/game-agent-browser-spec.md. Edit docs/ instead. -->
