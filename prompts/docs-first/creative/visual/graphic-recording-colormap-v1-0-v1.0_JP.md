...
description: "画像からライトテーマとダークテーマのカラーマップを作成するプロンプト「カラーマップ生成プロンプト v1.0」できた!!"
canonical_id: "creative/visual/graphic-recording-colormap-v1-0-v1.0"
canonical_doc: "docs/prompt-catalog/creative/visual/graphic-recording-colormap-v1-0-v1.0.md"
locale: JP
docs_first: true
last_synced: 2026-03-19
---

<!-- Generated from docs/prompt-catalog/creative/visual/graphic-recording-colormap-v1-0-v1.0.md. Edit docs/ instead. -->
