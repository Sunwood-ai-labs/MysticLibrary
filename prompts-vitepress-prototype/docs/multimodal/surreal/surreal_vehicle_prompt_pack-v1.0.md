---
title: "現実×シュール乗り物 一括生成プロンプト V1.0"
sourcePath: "prompts/multimodal/surreal/surreal_vehicle_prompt_pack-v1.0_JP.md"
locale: "ja"
contentKind: "markdown"
---
> このページは prompts ソースツリーから自動生成されています。
> ソース: `prompts/multimodal/surreal/surreal_vehicle_prompt_pack-v1.0_JP.md`
> 英語版: [EN](/en/multimodal/surreal/surreal_vehicle_prompt_pack-v1.0)
