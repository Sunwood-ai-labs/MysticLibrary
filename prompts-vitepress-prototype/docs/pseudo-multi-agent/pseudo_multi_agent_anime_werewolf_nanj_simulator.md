---
title: "疑似マルチエージェント人狼シミュレーター - なんJ風掲示板版プロンプト"
sourcePath: "prompts/pseudo-multi-agent/pseudo_multi_agent_anime_werewolf_nanj_simulator_JP.md"
locale: "ja"
contentKind: "markdown"
---
> このページは prompts ソースツリーから自動生成されています。
> ソース: `prompts/pseudo-multi-agent/pseudo_multi_agent_anime_werewolf_nanj_simulator_JP.md`
> 英語版: [EN](/en/pseudo-multi-agent/pseudo_multi_agent_anime_werewolf_nanj_simulator)
