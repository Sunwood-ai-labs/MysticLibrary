---
title: "VoiceVox MCP自動プレゼンテーション プロンプト"
sourcePath: "prompts/presentation/voicevox_auto_presenter-v1_JP.md"
locale: "ja"
contentKind: "markdown"
---
> このページは prompts ソースツリーから自動生成されています。
> ソース: `prompts/presentation/voicevox_auto_presenter-v1_JP.md`
> 英語版: [EN](/en/presentation/voicevox_auto_presenter-v1)
