...
sourcePath: "prompts/agent/minecraft/minecraft_mcp_builder_prompt-v1.1_JP.md"
locale: "ja"
contentKind: "markdown"
---
> このページは prompts ソースツリーから自動生成されています。
> ソース: `prompts/agent/minecraft/minecraft_mcp_builder_prompt-v1.1_JP.md`
> 英語版: [EN](/en/agent/minecraft/minecraft_mcp_builder_prompt-v1.1)
