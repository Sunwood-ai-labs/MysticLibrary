...
sourcePath: "prompts/Company-as-a-Code/Phidata-Prompt-Template_JP.md"
locale: "ja"
contentKind: "markdown"
---
> このページは prompts ソースツリーから自動生成されています。
> ソース: `prompts/Company-as-a-Code/Phidata-Prompt-Template_JP.md`
> 英語版: [EN](/en/Company-as-a-Code/Phidata-Prompt-Template)
