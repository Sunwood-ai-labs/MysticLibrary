---
title: "🤖 phidata-cookbook AIエージェント一覧"
sourcePath: "prompts/Company-as-a-Code/phidate-cookbook_Repository_summary_JP.md"
locale: "ja"
contentKind: "markdown"
---
> このページは prompts ソースツリーから自動生成されています。
> ソース: `prompts/Company-as-a-Code/phidate-cookbook_Repository_summary_JP.md`
> 英語版: [EN](/en/Company-as-a-Code/phidate-cookbook_Repository_summary)
