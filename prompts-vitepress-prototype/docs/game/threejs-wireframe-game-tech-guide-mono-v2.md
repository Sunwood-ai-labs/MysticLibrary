---
title: "Three.jsワイヤーアートゲーム 技術スタックプロンプト モノクロ版 V2"
sourcePath: "prompts/game/threejs-wireframe-game-tech-guide-mono-v2_JP.md"
locale: "ja"
contentKind: "markdown"
---
> このページは prompts ソースツリーから自動生成されています。
> ソース: `prompts/game/threejs-wireframe-game-tech-guide-mono-v2_JP.md`
