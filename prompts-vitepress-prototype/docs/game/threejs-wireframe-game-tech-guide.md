---
title: "Three.jsワイヤーアートゲーム 技術スタックプロンプト"
sourcePath: "prompts/game/threejs-wireframe-game-tech-guide_JP.md"
locale: "ja"
contentKind: "markdown"
---
> このページは prompts ソースツリーから自動生成されています。
> ソース: `prompts/game/threejs-wireframe-game-tech-guide_JP.md`
> 英語版: [EN](/en/game/threejs-wireframe-game-tech-guide)
