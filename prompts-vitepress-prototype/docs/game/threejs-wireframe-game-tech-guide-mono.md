---
title: "Three.jsワイヤーアートゲーム 技術スタックプロンプト モノクロ版"
sourcePath: "prompts/game/threejs-wireframe-game-tech-guide-mono_JP.md"
locale: "ja"
contentKind: "markdown"
---
> このページは prompts ソースツリーから自動生成されています。
> ソース: `prompts/game/threejs-wireframe-game-tech-guide-mono_JP.md`
> 英語版: [EN](/en/game/threejs-wireframe-game-tech-guide-mono)
