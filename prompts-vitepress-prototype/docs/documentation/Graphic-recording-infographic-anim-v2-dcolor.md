---
title: "グラフィックレコーディング (グラレコ) HTML 作成プロンプト V2 （フルムーン ダークテーマ版）"
sourcePath: "prompts/documentation/Graphic-recording-infographic-anim-v2-dcolor_JP.md"
locale: "ja"
contentKind: "markdown"
---
> このページは prompts ソースツリーから自動生成されています。
> ソース: `prompts/documentation/Graphic-recording-infographic-anim-v2-dcolor_JP.md`
> 英語版: [EN](/en/documentation/Graphic-recording-infographic-anim-v2-dcolor)
