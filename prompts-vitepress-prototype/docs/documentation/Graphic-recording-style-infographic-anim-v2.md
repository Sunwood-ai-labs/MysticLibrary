---
title: "グラフィックレコーディング風インフォグラフィック変換プロンプト V2"
sourcePath: "prompts/documentation/Graphic-recording-style-infographic-anim-v2_JP.md"
locale: "ja"
contentKind: "markdown"
---
> このページは prompts ソースツリーから自動生成されています。
> ソース: `prompts/documentation/Graphic-recording-style-infographic-anim-v2_JP.md`
> 英語版: [EN](/en/documentation/Graphic-recording-style-infographic-anim-v2)
