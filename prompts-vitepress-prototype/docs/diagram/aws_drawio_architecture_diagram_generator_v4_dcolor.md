---
title: "AWS & Draw.io アーキテクチャダイアグラム生成プロンプト V4 (experimental)"
sourcePath: "prompts/diagram/aws_drawio_architecture_diagram_generator_v4_dcolor_JP.md"
locale: "ja"
contentKind: "markdown"
---
> このページは prompts ソースツリーから自動生成されています。
> ソース: `prompts/diagram/aws_drawio_architecture_diagram_generator_v4_dcolor_JP.md`
> 英語版: [EN](/en/diagram/aws_drawio_architecture_diagram_generator_v4_dcolor)
