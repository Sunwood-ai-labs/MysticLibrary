---
title: "🎨 カラーマップ生成プロンプト v3.0 - 画像URL対応・LP風・FontAwesome強化版"
sourcePath: "prompts/colormap/LP-style/colormap-generator-v3.0_JP.md"
locale: "ja"
contentKind: "markdown"
---
> このページは prompts ソースツリーから自動生成されています。
> ソース: `prompts/colormap/LP-style/colormap-generator-v3.0_JP.md`
