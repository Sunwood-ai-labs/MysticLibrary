---
title: "Graphic Recording (Graleco) HTML Creation Prompt with Timeline V2"
sourcePath: "prompts/documentation/Graphic-recording-infographic-anim-Timeline-v2_EN.md"
locale: "en"
contentKind: "markdown"
---
> This page is generated from the prompts source tree.
> Source: `prompts/documentation/Graphic-recording-infographic-anim-Timeline-v2_EN.md`
> Japanese: [JA](/documentation/Graphic-recording-infographic-anim-Timeline-v2)

# Graphic Recording (Graleco) HTML Creation Prompt with Timeline V2

## Purpose
Please convert the following content into a perfect Japanese graphic recording-style HTML infographic that looks like it was created by a top-tier designer. Aim for the highest standards in both information design and visual design.
Visually represent content utilizing handwritten-style shapes and icons.
...
- Hand-drawn style frames, arrows, banners, speech bubbles
...
- Emphasize keywords with frames and colors
...
- Effectively utilize whitespace to ensure visibility
- Express movement with animation and hover effects
...
<ul class="timeline">
	...
	<li>
		<h2 id="hominini"></h2>
		<time><strong>6</strong><span>MILLION<br><em>years ago</em></span></time>
...
- Create friendliness with handwritten-style elements
- Design that remains in visual memory
- Clearly state source information in footer
- **Required**: Always apply "circle and flap decoration" to timelines (must include above CSS specification)
