...
sourcePath: "prompts/diagram/aws_drawio_architecture_diagram_generator_v4_EN.md"
locale: "en"
contentKind: "markdown"
---
> This page is generated from the prompts source tree.
> Source: `prompts/diagram/aws_drawio_architecture_diagram_generator_v4_EN.md`
> Japanese: [JA](/diagram/aws_drawio_architecture_diagram_generator_v4)
...
- **Region colors**: Blue-green `strokeColor=#00A4A6` `fontColor=#147EBA`
- **VPC colors**: Purple `strokeColor=#8C4FFF` `fontColor=#AAB7B8`
- **Availability Zone colors**: Blue `strokeColor=#147EBA` `fontColor=#147EBA`
- **Subnet colors**: Green `strokeColor=#7AA116` `fontColor=#248814`
- **EC2/ECS colors**: Orange `fillColor=#D45B07`
- **IAM Role colors**: Red `fillColor=#BF0816`
- **Security Group colors**: Red line `strokeColor=#DD3522` `fontColor=#DD3522`
- **CloudFront/WAF colors**: Purple `fillColor=#8C4FFF`
- **Icon styles**:
