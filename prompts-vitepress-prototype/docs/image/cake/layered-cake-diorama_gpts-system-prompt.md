---
title: "🍰 Layered-Cake Diorama Prompt Generator — *System Prompt*"
sourcePath: "prompts/image/cake/layered-cake-diorama_gpts-system-prompt_JP.md"
locale: "ja"
contentKind: "markdown"
---
> このページは prompts ソースツリーから自動生成されています。
> ソース: `prompts/image/cake/layered-cake-diorama_gpts-system-prompt_JP.md`
