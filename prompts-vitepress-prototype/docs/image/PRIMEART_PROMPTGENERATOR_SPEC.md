---
title: "LLM向け要件定義書：指定キーワードから素数×画像生成プロンプトを生成"
sourcePath: "prompts/image/PRIMEART_PROMPTGENERATOR_SPEC_JP.md"
locale: "ja"
contentKind: "markdown"
---
> このページは prompts ソースツリーから自動生成されています。
> ソース: `prompts/image/PRIMEART_PROMPTGENERATOR_SPEC_JP.md`
