---
title: "Claudeハンド型AIギャル作業ディレクトリプロンプト"
sourcePath: "prompts/coding/AI-Gal-Claude-Hand-v1_JP.md"
locale: "ja"
contentKind: "markdown"
---
> このページは prompts ソースツリーから自動生成されています。
> ソース: `prompts/coding/AI-Gal-Claude-Hand-v1_JP.md`
> 英語版: [EN](/en/coding/AI-Gal-Claude-Hand-v1)
