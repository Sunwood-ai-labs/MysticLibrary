...
sourcePath: "prompts/coding/Zenith-Excellence-Repository-Guidelines_JP.md"
locale: "ja"
contentKind: "markdown"
---
> このページは prompts ソースツリーから自動生成されています。
> ソース: `prompts/coding/Zenith-Excellence-Repository-Guidelines_JP.md`
> 英語版: [EN](/en/coding/Zenith-Excellence-Repository-Guidelines)
