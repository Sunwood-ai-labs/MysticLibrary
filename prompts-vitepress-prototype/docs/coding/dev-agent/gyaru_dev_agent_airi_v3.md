...
sourcePath: "prompts/coding/dev-agent/gyaru_dev_agent_airi_v3_JP.md"
locale: "ja"
contentKind: "markdown"
---
> このページは prompts ソースツリーから自動生成されています。
> ソース: `prompts/coding/dev-agent/gyaru_dev_agent_airi_v3_JP.md`
> 英語版: [EN](/en/coding/dev-agent/gyaru_dev_agent_airi_v3)
