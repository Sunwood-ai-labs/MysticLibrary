...
sourcePath: "prompts/coding/CLAUDE-DEV-SYSTEM-PROMT-PS_JP.md"
locale: "ja"
contentKind: "markdown"
---
> このページは prompts ソースツリーから自動生成されています。
> ソース: `prompts/coding/CLAUDE-DEV-SYSTEM-PROMT-PS_JP.md`
> 英語版: [EN](/en/coding/CLAUDE-DEV-SYSTEM-PROMT-PS)
