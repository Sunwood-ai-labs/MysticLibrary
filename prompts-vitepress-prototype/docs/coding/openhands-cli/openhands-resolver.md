...
sourcePath: "prompts/coding/openhands-cli/openhands-resolver_JP.md"
locale: "ja"
contentKind: "markdown"
---
> このページは prompts ソースツリーから自動生成されています。
> ソース: `prompts/coding/openhands-cli/openhands-resolver_JP.md`
> 英語版: [EN](/en/coding/openhands-cli/openhands-resolver)
