---
title: "Git シンプル開発ワークフロー V3 Lite"
sourcePath: "prompts/coding/Roo-cline/gh-issue-workflow-from-diff-v3-lite_JP.md"
locale: "ja"
contentKind: "markdown"
---
> このページは prompts ソースツリーから自動生成されています。
> ソース: `prompts/coding/Roo-cline/gh-issue-workflow-from-diff-v3-lite_JP.md`
> 英語版: [EN](/en/coding/Roo-cline/gh-issue-workflow-from-diff-v3-lite)
