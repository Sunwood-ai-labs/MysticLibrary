---
title: "Git 差分解析自動コミット プロンプト V4.0 lite PS"
sourcePath: "prompts/coding/Roo-cline/git_auto_commit_prompt-v4-lite-ps_JP.md"
locale: "ja"
contentKind: "markdown"
---
> このページは prompts ソースツリーから自動生成されています。
> ソース: `prompts/coding/Roo-cline/git_auto_commit_prompt-v4-lite-ps_JP.md`
> 英語版: [EN](/en/coding/Roo-cline/git_auto_commit_prompt-v4-lite-ps)
