---
title: "リポジトリ品質確認プロンプト V4"
sourcePath: "prompts/coding/Roo-cline/repo-review-prompt-v4_JP.md"
locale: "ja"
contentKind: "markdown"
---
> このページは prompts ソースツリーから自動生成されています。
> ソース: `prompts/coding/Roo-cline/repo-review-prompt-v4_JP.md`
> 英語版: [EN](/en/coding/Roo-cline/repo-review-prompt-v4)
