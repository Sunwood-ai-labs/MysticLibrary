---
title: "Git開発ワークフロー自動化プロンプト"
sourcePath: "prompts/coding/Roo-cline/gh-issue-workflow-from-diff-v2_JP.md"
locale: "ja"
contentKind: "markdown"
---
> このページは prompts ソースツリーから自動生成されています。
> ソース: `prompts/coding/Roo-cline/gh-issue-workflow-from-diff-v2_JP.md`
> 英語版: [EN](/en/coding/Roo-cline/gh-issue-workflow-from-diff-v2)
