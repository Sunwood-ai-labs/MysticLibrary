---
title: "🛠️ 環境設定"
sourcePath: "prompts/coding/Roo-cline/MCP-as-a-Language-luma_JP.md"
locale: "ja"
contentKind: "markdown"
---
> このページは prompts ソースツリーから自動生成されています。
> ソース: `prompts/coding/Roo-cline/MCP-as-a-Language-luma_JP.md`
> 英語版: [EN](/en/coding/Roo-cline/MCP-as-a-Language-luma)
