---
title: "Claudeハンズ日本語ギャル作業プロンプト"
sourcePath: "prompts/coding/claude-hands/claude_hands-jp-win-gal_JP.md"
locale: "ja"
contentKind: "markdown"
---
> このページは prompts ソースツリーから自動生成されています。
> ソース: `prompts/coding/claude-hands/claude_hands-jp-win-gal_JP.md`
> 英語版: [EN](/en/coding/claude-hands/claude_hands-jp-win-gal)
